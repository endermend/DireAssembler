...
public class ModelDireAssembler extends ModelBase {
	...
	public void render(final Entity entity, final float f, final float f1, final float f2, final float f3,
		...
		this.renderOuterFrameSide(ModelDireAssembler.HALF_TURN, f5);
		this.renderOuterFrameSide(-ModelDireAssembler.HALF_TURN, f5);
		this.renderOuterFrameSide(ModelDireAssembler.FULL_TURN, f5);

		// Render the inner frame
		this.renderInnerFrameSide(0, 0, f5);
		this.renderInnerFrameSide(ModelDireAssembler.HALF_TURN, 0, f5);
		this.renderInnerFrameSide(-ModelDireAssembler.HALF_TURN, 0, f5);
		this.renderInnerFrameSide(ModelDireAssembler.FULL_TURN, 0, f5);
		this.renderInnerFrameSide(0, ModelDireAssembler.HALF_TURN, f5);
		this.renderInnerFrameSide(0, -ModelDireAssembler.HALF_TURN, f5);
		...
		this.renderGlassSide(ModelDireAssembler.HALF_TURN, 0, f5);
		this.renderGlassSide(-ModelDireAssembler.HALF_TURN, 0, f5);
		this.renderGlassSide(ModelDireAssembler.FULL_TURN, 0, f5);
		this.renderGlassSide(0, ModelDireAssembler.HALF_TURN, f5);
		this.renderGlassSide(0, -ModelDireAssembler.HALF_TURN, f5);
