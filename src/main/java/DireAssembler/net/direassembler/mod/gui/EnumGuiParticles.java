...
public enum EnumGuiParticles {
	Knowledge(new ResourceLocation("direassembler", "textures/misc/particles.png"), 0, 64, 16, 16, 16, 0, 4);
	...
	/**
	 * Draws the particle. If settings "needsPrepare" to false, prepare and finish
	 * must be called manually. However this can be useful if drawing multiple of
	 * the same particle.
	 *
	 * @param gui
	 * @param positionX
	...
	/**
	 * Prepares the engine to draw this particle. Must be called before drawing, but
	 * can be called once then draw called multiple times for the same particle.
	 */
