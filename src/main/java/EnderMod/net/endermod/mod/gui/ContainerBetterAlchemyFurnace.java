...
public class ContainerBetterAlchemyFurnace extends Container{
	private TileBetterAlchemyFurnace furnace;
	  ...
	  public ContainerBetterAlchemyFurnace(InventoryPlayer player, TileBetterAlchemyFurnace tileEntity) {
	    this.furnace = tileEntity;
	    addSlotToContainer(new SlotLimitedHasAspects((IInventory)tileEntity, 0, 80, 8));
	    addSlotToContainer(new Slot((IInventory)tileEntity, 1, 80, 48));
	    int i;
	    for (i = 0; i < 3; i++) {
	      for (int j = 0; j < 9; j++)
